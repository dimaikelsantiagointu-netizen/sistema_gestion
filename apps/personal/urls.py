...
urlpatterns = [
    # ==============================================================================
    # 1. GESTIÓN DE PERSONAL (TRABAJADORES)
    # ==============================================================================
    ...
    # GESTIÓN DE DOCUMENTOS DEL EXPEDIENTE
    path('expediente/<int:pk>/subir/', views.subir_archivo_personal, name='subir_archivo'),
    path('documento/eliminar/<int:doc_id>/', views.eliminar_documento_personal, name='eliminar_documento'),

    # ==============================================================================
    # 2. SUBMÓDULO: UNIDADES ADSCRITAS (NUEVO)
    # ==============================================================================
